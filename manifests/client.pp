...
# for active checks. If port is not specified, default port is used.
# [*hostname*]
#   Unique, case sensitive hostname. Required for active checks and must match
# hostname as configured on the server.
# [*conf_pid_file*]
#   Name of PID file.
# [*conf_log_file*]
...
# 'root', the agent will try to switch to user 'zabbix' instead. Has no effect
# if started under a regular user.
# [*time_out*]
#   Spend no more than Timeout seconds on processing
# [*include_dir*]
#   You may include individual files or all files in a directory in the
# configuration file. Installing Zabbix will create include directory in
# /etc/zabbix, unless modified during the compile time.
...
# - запускает и контролирует демон zabbix-agent / run and control zabbix-agent
# daemon
#
# === Examples
#  class {'zabbix::client':
